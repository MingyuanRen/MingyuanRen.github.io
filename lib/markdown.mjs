...
import { markdownText, excerpt, firstUploadedImage } from "./text.mjs";
...
export function parsePost(source, path) {
  ...
  return {
    ...
    excerpt: excerpt(markdownText(parts[2]), 400),
    coverImage: ranking?.boardImage || ranking?.items[0]?.image || firstUploadedImage(parts[2]) || "/avatar.jpg",
